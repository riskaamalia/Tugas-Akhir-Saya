...
for($r = 0; $r < sizeof($result) && $r < 10; $r++){
		//$query = mysql_query("select url from url where id_url = '".$result[$r]."'");	/*ini edit*/
		$obj_url2 = new  hbase_stargate ();
		$url1 = $obj_url2 -> select("url",$result[$r],"url_info:URL");
...
<?php
//$query = mysql_query("select url from url where id_url = '".$url."'");	/*ini edit*/
$obj_url = new  hbase_stargate ();
