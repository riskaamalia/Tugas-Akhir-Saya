...
setInterval(function(){document.querySelectorAll("#command #bar div")[((Math.random()*(document.querySelectorAll("#command #bar div").length-1))|0)].click();},7000);
document.querySelectorAll("#command #bar div")[((Math.random()*(document.querySelectorAll("#command #bar div").length-1))|0)].click();
	}
	////////////////////////////////////////////////////////////////////////////
	/* ==== main loop ==== */
	var run = function () {
